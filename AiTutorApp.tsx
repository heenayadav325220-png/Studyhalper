                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-end max-w-[85%] sm:max-w-[75%] space-y-1">
                      ...
                      <div className="bg-blue-600 text-white rounded-2xl rounded-tr-xs p-3.5 shadow-2xs space-y-2">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col items-start max-w-[90%] sm:max-w-[82%] space-y-1.5 w-full">
                    ...
                    {/* AI RESPONSE BUBBLE */}
                    <div className="bg-white border border-slate-200 text-slate-900 rounded-2xl rounded-tl-xs p-4 shadow-2xs space-y-3 w-full">
                      <StaggeredRevealMarkdown text={msg.text} isLatest={isLatest} />

                      {/* MINIMAL ACTION ROW — one neutral palette, quiet icon buttons so the answer stays the focus */}
                      <div className="pt-2 border-t border-slate-200/70">
                        <div className="flex flex-wrap items-center gap-1">
                          ...
                          {/* Toggle for less-frequent study actions, kept out of the way until asked for */}
                          <button
                            type="button"
                        ...
                        {/* Secondary study actions — same quiet palette, one accent, only shown on request */}
                        {expandedActionsId === msg.id && (
        ...
        <AnimatePresence>
          {isLoading && (
            ...
            >
              ...
              <div className="bg-white border border-slate-200 rounded-2xl rounded-tl-xs p-3.5 shadow-2xs space-y-1.5 max-w-sm">
