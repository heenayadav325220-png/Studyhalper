...
export default function App() {
  ...
  // Discuss Diagram with AI Tutor Callback
  const handleDiscussDiagram = async (diagramTitle: string) => {
    setActiveTab('chat');
    setActiveGroup(null);
    const messageText = appLanguage === 'Hindi'
      ? `मुझे "${diagramTitle}" डायग्राम के बारे में विस्तार से समझाएं और महत्वपूर्ण बातें बताएं।`
      : `Please explain the structure, components, and significance of the "${diagramTitle}" diagram in depth.`;
    ...
    try {
      ...
      const answer = await getStudyAnswer(messageText, undefined, studentContext, appLanguage);
      const newModelMsg: ChatMessage = { role: 'model', text: answer };
            ...
            >
              ...
              {activeTab === 'diagram' && (
                <DiagramMaker 
                  ...
                  onDiscussWithTutor={handleDiscussDiagram}
                />
              )}
          ...
          {isToolkitOpen && (
            <Suspense fallback={
              ...
              <InteractiveToolkit 
                ...
                onOpenDiagramMaker={(prompt, title, subject) => {
                  setBackgroundDiagram({
                    status: 'idle',
                    prompt: prompt || '',
                    title: title || '',
