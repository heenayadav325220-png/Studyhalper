          ...
          <AnimatePresence initial={false}>
            {messages.map((msg, idx) => {
              ...
              return (
                ...
                >
                  {/* BOT AVATAR CIRCLE */}
                  <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-blue-50 ring-2 ring-white flex items-center justify-center text-blue-600 shadow-sm shrink-0 mt-4">
                  ...
                  <div className="flex flex-col items-start max-w-[90%] sm:max-w-[82%] space-y-1.5 w-full">
                    ...
                    {/* AI RESPONSE BUBBLE */}
                    <div className="bg-white border border-slate-200 text-slate-900 rounded-2xl rounded-tl-md p-4 shadow-sm space-y-3 w-full">
