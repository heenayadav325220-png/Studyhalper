export type AppLanguage = 'English' | 'Hindi' | 'Hinglish' | 'Marathi' | 'Tamil' | 'Bengali' | 'Spanish' | 'French' | 'German' | 'Russian' | 'Chinese';
...
export const TRANSLATIONS: Record<string, Partial<Record<AppLanguage, string>>> = {
  ...
  'notebook_desc': {
    ...
    Marathi: 'सूत्र पत्रक आणि मुख्य तथ्ये',
    Tamil: 'சூத்திர தாள்கள் & முக்கிய உண்மைகள்',
    Bengali: 'সূত্র শীট এবং গুরুত্বপূর্ণ তথ্য',
    Spanish: 'Hojas de fórmulas y datos clave',
    French: 'Fiches de formules & faits marquants',
    German: 'Formelblätter & wichtige Fakten',
    Russian: 'Формулы и ключевые факты',
    Chinese: '公式表和核心知识点'
  },
  'quiz_tag': {
    English: 'Dynamically Generated via Gemini AI',
    Hindi: 'जेमिनी एआई द्वारा संचालित गतिशील प्रश्नोत्तरी',
    Hinglish: 'Dynamically Generated via Gemini AI',
    Marathi: 'जेमिनी एआय द्वारे गतिमानपणे व्युत्पन्न',
    Tamil: 'ஜெமினி ஏஐ மூலம் உருவாக்கப்பட்டது',
    Bengali: 'জেমিমিন এআই দ্বারা উত্পন্ন',
    Spanish: 'Generado dinámicamente a través de Gemini AI',
    French: 'Généré dynamiquement par Gemini AI',
    German: 'Dynamisch generiert über Gemini AI'
  },
  'personal_buddy': {
    English: 'Personal AI Study Companion',
    ...
    Russian: 'Ваш личный ИИ-помощник в учебе',
    Chinese: '您的专属 AI 学习伙伴'
  },
